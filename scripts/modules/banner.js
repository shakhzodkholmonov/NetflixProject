import { createModal, getMovieImage, getTrailerVideo, paintGenres, saveLocalMovies } from "./utils.js";
...
export default function createBanner(data) {
  banner.style.backgroundImage = dynamicBgImage(data.poster_path, data.backdrop_path);
  ...
  addBtn.forEach((add) => add.addEventListener("click", () => saveLocalMovies(data)));
